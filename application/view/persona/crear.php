<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row ">
            <div class="col-lg-12">
                <h1 class="page-header"> Usuarios <i class="fa fa-users"></i> </h1>
            </div>
        </div>
                ...
                <div class="well">
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="">Primer Nombre <span class="ast">*</span></label>
                                <input type="text" class="form-control" name='primerNA' id="primerNA">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="">Segundo Nombre </label>
                                <input type="text" class="form-control" name='segundoNA' id="segundoNA">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="">Primer Apellido <span class="ast">*</span></label>
                                <input type="text" class="form-control" name='primerAA' id="primerAA">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="">Segundo Apellido <span class="ast">*</span></label>
                                <input type="text" class="form-control" name='segundoAA' id="segundoAA">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="">Dirección </label>
                                <input type="text" class="form-control" name='direccionA' id="direccionA">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    fecha == '' || genero ===''  || celular == '' || eps === '' || correo == '' || perfil=== '') {
        swal({
            title: '¡Error!',
        ...
        $.ajax({
            url: '<?=URL?>Persona/validar/'+tipo+'/'+documento,
            type: 'GET',
            dataType: 'JSON',
        }).done(function(data){
            if(data.success){
