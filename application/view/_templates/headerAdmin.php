            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <?php if(isset($_SESSION["instructor"]) ){ ?><i class="fa fa-user">
                        </i> <?php echo($_SESSION["instructor"]) ?> <?php } elseif(isset($_SESSION["admin"]) ){ ?><i class="fa fa-user">
                        </i> <?php echo($_SESSION["admin"]) ?> <?php } ?> <b class="caret"></b></a>  
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <!-- <ul id="demo4" class="collapse">
                            <li><a href="<?= URL ?>programacion/crear">Registrar Programación</a></li>
                            <li><a href="<?= URL ?>programacion/index">Consultar Programación</a></li>
                        </ul> -->
                    </li>
                    <?php } ?>
                    <?php if((isset($_SESSION["admin"])) || (isset($_SESSION["instructor"]))){ ?>
                    ...
                    <li>
                        ...
                        <ul id="demo6" class="collapse">
                            <li> <a href="<?= URL ?>controlE_S/crear">Registrar Asistencía</a></li>
                            <li><a href="<?= URL ?>controlE_S/index">Consultar Asistencía</a></li>
                        </ul>
                    </li>
                    <?php } ?>
                    <?php if(isset($_SESSION["admin"])){ ?>
                    <li>
                        ...
                        <ul id="demo7" class="collapse">
                            <li><a href="<?= URL ?>tipoNovedad/crear">Registrar Novedad</a> </li>
                            <li><a href="<?= URL ?>tipoNovedad/index">Consultar Novedad</a></li>
                        </ul>
                    </li>
                    <?php } ?>
                    <?php if(isset($_SESSION["admin"])){ ?>
