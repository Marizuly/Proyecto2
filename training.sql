...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-05-2018 a las 16:51:49
...
SELECT p.documento documento,CONCAT(p.primerNombre,' ',p.segundoNombre,' ',p.primerApellido,' ',p.segundoApellido) persona, rp.fechaRegistro fechaRegistro, rp.estadoRegistro estadoRegistro FROM persona p join registrospendientes rp on p.idregistrosPendientes = rp.idregistroPendiente where rp.estadoRegistro = 'Sin confirmar'$$
...
select correo, contrasena, idPerfil from persona where correo = _correo and contrasena = _contrasena$$
...
(1, 'Gap', 'especifica para trabajar gluteos, abdomen y piernas', 'Activo'),
(2, 'Spinning', 'tonificación y a una mejora general de tu estado fisico', NULL),
(3, 'Crossfit', ' incrementar la funcionalidad de los musculos', 'Activo'),
(4, 'Rumba aerobica', ' ejercicio fisico cardiovascular', NULL),
(5, 'Gap', 'La clase es muy interesante', 'Activo');
...
(1, 0, '2018-06-21', 93000, '2018-05-22', 'Activa', 3, 4),
(2, 0, '2018-05-23', 4000, '2018-05-22', 'Activa', 5, NULL),
(3, 0, '2018-06-21', 53000, '2018-05-22', 'Activa', 4, NULL);
...
INSERT INTO `controle_s` (`idcontrolE_S`, `entrada`, `idVenta`, `salida`) VALUES
(1, '2018-04-24 17:00:00', 1, '0000-00-00 00:00:00'),
(2, '2018-04-24 16:00:00', 2, '0000-00-00 00:00:00'),
(3, '2018-04-24 07:00:00', 3, '0000-00-00 00:00:00'),
(4, '2018-04-24 08:00:00', 4, '0000-00-00 00:00:00'),
(5, '2018-04-24 18:00:00', 5, '0000-00-00 00:00:00'),
(6, '2018-04-24 17:00:00', 6, '0000-00-00 00:00:00'),
(7, '2018-04-24 16:46:12', 2, '0000-00-00 00:00:00');
...
(3, 1037667450, 'Laura', 'Daniela', 'Morales', 'Hernández', '1999-03-21', '5443267', '3002375244', 'soltero', 'laura_candy@hotmail.es', 'cll65 ba cr 109', 3, 1, 2, NULL, 2, NULL, 'Activo', NULL),
...
(5, 43143033, 'Gloria', '', 'Amparo', 'Hernández', '1991-11-04', '1234567', '3197972549', 'union libre', 'gloria@gmail.com', 'cll65 ba cr 109', 3, 1, 2, NULL, 1, NULL, 'Activo', NULL);
...
(3, '10:00:00', '11:00:00', '14:00:00', '16:00:00', 3, ''),
(4, '08:00:00', '10:00:00', '12:00:00', '16:00:00', 4, ''),
(5, '09:00:00', '11:00:00', '12:00:00', '17:00:00', 5, ''),
(6, '10:30:00', '11:30:00', '15:00:00', '16:00:00', 6, ''),
...
(1, NULL, '2017-07-13 05:00:00', '0000-00-00 00:00:00'),
(2, NULL, '2017-02-04 05:00:00', '0000-00-00 00:00:00'),
(3, NULL, '2016-05-09 05:00:00', '0000-00-00 00:00:00'),
(4, NULL, '2017-07-11 05:00:00', '0000-00-00 00:00:00'),
(5, NULL, '2016-09-23 05:00:00', '0000-00-00 00:00:00'),
(6, NULL, '2017-10-20 05:00:00', '0000-00-00 00:00:00'),
(7, NULL, '2017-07-13 05:00:00', '0000-00-00 00:00:00'),
(8, NULL, '2017-02-04 05:00:00', '0000-00-00 00:00:00'),
(9, NULL, '2016-05-09 05:00:00', '0000-00-00 00:00:00'),
(10, NULL, '2017-07-11 05:00:00', '0000-00-00 00:00:00'),
(11, NULL, '2016-09-23 05:00:00', '0000-00-00 00:00:00'),
(12, 'Sin confirmar', '2017-10-20 05:00:00', '0000-00-00 00:00:00'),
(13, 'Sin confirmar', '2018-04-16 05:00:00', '0000-00-00 00:00:00'),
(14, '', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(15, 'Sin confirmar', '2018-04-20 15:48:05', '0000-00-00 00:00:00'),
(16, 'Sin confirmar', '2018-04-20 20:31:29', '0000-00-00 00:00:00'),
(17, 'Sin confirmar', '2018-04-22 17:03:59', '0000-00-00 00:00:00'),
(18, 'Sin confirmar', '2018-04-23 13:48:43', '0000-00-00 00:00:00'),
(19, 'Sin confirmar', '2018-04-23 13:57:19', '0000-00-00 00:00:00'),
(20, 'Sin confirmar', '2018-04-23 13:58:04', '0000-00-00 00:00:00'),
(21, 'Sin confirmar', '2018-04-23 14:00:24', '0000-00-00 00:00:00'),
(22, 'Sin confirmar', '2018-04-23 15:14:44', '0000-00-00 00:00:00'),
(23, 'Sin confirmar', '2018-04-23 15:22:37', '0000-00-00 00:00:00'),
(24, 'Sin confirmar', '2018-04-23 15:23:10', '0000-00-00 00:00:00'),
(25, 'Sin confirmar', '2018-04-23 15:32:23', '0000-00-00 00:00:00'),
(26, 'Sin confirmar', '2018-04-23 15:41:03', '0000-00-00 00:00:00'),
...
--
ALTER TABLE `comprobanteservicio`
  MODIFY `idcomprobanteServicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `controle_s`
--
ALTER TABLE `controle_s`
  MODIFY `idcontrolE_S` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `eps`
--
ALTER TABLE `eps`
  MODIFY `ideps` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `horarioventa`
  MODIFY `idhorarioVenta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `planeshorario`
  MODIFY `idplanesHorario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `programacion`
--
ALTER TABLE `programacion`
  MODIFY `idProgramacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `registrospendientes`
--
ALTER TABLE `registrospendientes`
  MODIFY `idregistroPendiente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
